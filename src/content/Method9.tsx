  ...
  return (
    <Box p={4} maxW="1200px" mx="auto">
      ...
      <Text fontSize="md" fontFamily="Verdana" lineHeight="1.8" mb={6}>
        ...
        Network：畳み込みニューラルネットワーク）は、画像認識において最も成功した深層学習アーキテクチャです。画像の空間的な特徴を効率的に学習できる構造を持ち、画像分類、物体検出、セグメンテーションなど、様々なタスクで高い性能を発揮します。
      </Text>
      ...
      <Text fontSize="md" fontFamily="Verdana" lineHeight="1.8" mb={6}>
        画像認識（Image
        Classification）は、入力画像が何を表しているかを判定するタスクです。例えば、画像が「猫」「犬」「車」のどれであるかを分類します。物体検出とは異なり、画像全体に対して1つのラベルを予測します。
      </Text>
      ...
      <List spacing={4} styleType="decimal" pl={4} mb={8}>
        ...
        <ListItem>
          ...
          <Text fontSize="md" lineHeight="1.8" mb={2}>
            特徴マップのサイズを縮小し、計算量を削減するとともに、位置のずれに対する頑健性を高めます。代表的な手法にMax
            PoolingとAverage Poolingがあります。
          </Text>
      ...
      <List spacing={4} styleType="decimal" pl={4} mb={8}>
        <ListItem>
          ...
          <Text fontSize="md" lineHeight="1.8">
            ...
            2012で、従来手法を大きく上回る精度を達成しました。ReLU活性化関数、Dropout、データ拡張などの技術を導入し、深層学習の有効性を実証しました。
          </Text>
        </ListItem>
        ...
        <ListItem>
          ...
          <Text fontSize="md" lineHeight="1.8" mb={2}>
            残差接続（Skip
            Connection）を導入することで、勾配消失問題を解決し、100層を超える超深層ネットワークの学習を可能にしました。
          </Text>
          <Box mb={4}>
          ...
          <Text fontSize="md" lineHeight="1.8">
            ...
            は残差関数、
            <InlineMath math="x" />
            は入力です。ネットワークは差分（残差）を学習するため、学習が容易になります。
          </Text>
        </ListItem>
    ...
    for images, labels in train_loader:
      ...
      <List spacing={3} styleType="disc" pl={4} mb={8}>
        <ListItem>
          <Text fontSize="md" lineHeight="1.8">
            <strong>計算コスト:</strong>{" "}
            大規模モデルの学習には膨大な計算資源が必要
          </Text>
        </ListItem>
        <ListItem>
          <Text fontSize="md" lineHeight="1.8">
            <strong>解釈性:</strong>{" "}
            なぜその判断をしたのかの説明が困難（ブラックボックス問題）
          </Text>
        </ListItem>
        <ListItem>
          <Text fontSize="md" lineHeight="1.8">
